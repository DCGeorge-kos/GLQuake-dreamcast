Here is the starting point for this project :

https://github.com/dreameatergames/nuquake_enhanced/releases/tag/alpha_0.4.0

Compiling :

Clone this repo / make clean / make

All credits go to authors listed below.
